...
public class Commands 
{
    ...
    public void Command_GetAllComponents(IServerDocumentView view, string parameters)
        ...
        public void Command_GetNetsOfComponents(IServerDocumentView view, string parameters)
        {
            int j, k;
        ...
        public void Command_GetNetsOfSelectedComponents(IServerDocumentView view, string parameters)
        {
            int j, k;
            List<string> compInfo = new List<string>();
            IComponent comp;
        ...
        public void Command_GetAllComponentsParameters(IServerDocumentView view, string parameters)
        {
            IClient client = DXP.GlobalVars.Client;
            IWorkspace workSpace = client.GetDXPWorkspace() as IWorkspace;
            IProject project = workSpace.DM_FocusedProject();
        ...
        public void Command_GetComponentData(IServerDocumentView view, string parameters, bool compSelection)
        {
            int j, k;
            List<string> compInfo = new List<string>();
            IComponent comp;
